...
#
# lbl = tk.Label(root, text="Pcos Disease Detection", font=('times', 35,' bold '), height=1, width=65,bg="violet Red",fg="Black")
# lbl.place(x=0, y=0)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:/project code/100%code Tea Leaf Disease', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
